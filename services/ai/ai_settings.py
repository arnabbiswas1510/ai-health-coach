...
class AISettings:
    ...
    model_assignments: dict[AIMode, dict[AgentRole, str]] = field(
        default_factory=lambda: {
            AIMode.STANDARD: {
                AgentRole.SUMMARIZER: "gemini-1.5-flash",
                AgentRole.FORMATTER: "gemini-1.5-flash",
                AgentRole.METRICS_EXPERT: "gemini-1.5-flash",
                AgentRole.PHYSIOLOGY_EXPERT: "gemini-1.5-flash",
                AgentRole.ACTIVITY_EXPERT: "gemini-1.5-flash",
                AgentRole.SYNTHESIS: "gemini-1.5-flash",
                AgentRole.WORKOUT: "gemini-1.5-flash",
                AgentRole.SEASON_PLANNER: "gemini-1.5-flash",
                AgentRole.COMBINED_SUMMARIZER: "gemini-1.5-flash",
                AgentRole.COMBINED_ANALYST: "gemini-1.5-flash",
            },
